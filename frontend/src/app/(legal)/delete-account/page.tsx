...
import {
  Trash2, ShieldAlert, CheckCircle2, Mail, AlertTriangle,
  Clock, Database, Lock, FileText,
} from "lucide-react";
...
// ── what gets deleted ─────────────────────────────────────────────────────────
const DATA_ITEMS = [
  { icon: Mail,     label: "Account & profile",       desc: "Email address, name, and avatar" },
  { icon: Database, label: "All transaction data",    desc: "Income, expenses, categories, and notes" },
  { icon: FileText, label: "Reports & feedback",      desc: "Any messages or reports you submitted" },
  { icon: Lock,     label: "Authentication tokens",   desc: "All active sessions are invalidated" },
];
        ...
        {submitted ? (
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="mt-2 space-y-1 text-sm text-muted-foreground list-disc list-inside">
                    ...
                    <li>Your account will be <strong>permanently deleted within 30 days</strong>.</li>
                    <li>You can cancel by logging into the app before deletion completes.</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div>
              ...
              <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">Delete Your Account</h1>
              <p className="mt-2 text-muted-foreground">
                Permanently remove your CashFlow account and all associated data. This action is
                irreversible.
              </p>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-[var(--radius-xl)] border border-destructive/30 bg-destructive/5 p-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground">
                  All your data will be permanently deleted within 30 days and cannot be
                  recovered. Export your data from the app before proceeding.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-[var(--radius-xl)] border border-border bg-secondary/50 p-4">
              ...
              <p className="text-xs text-muted-foreground">
                Certain anonymised data may be retained for up to 90 days for fraud prevention and
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              {errors.agree && (
                <p className="text-xs text-destructive -mt-3">{errors.agree.message}</p>
              )}
            ...
            <div className="rounded-[var(--radius-xl)] border border-border bg-card p-5 space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>
                  • To <strong className="text-foreground">pause</strong> the app, simply log out —
                  your data is safe.
                </li>
                <li>
                  • To <strong className="text-foreground">export your data</strong>, go to{" "}
                ...
                <li>
                  ...
                  <a href="mailto:schoolasium123@gmail.com" className="text-foreground underline underline-offset-2">
                    schoolasium123@gmail.com
                  </a>.
                </li>
              </ul>
            </div>
