...
<head>
  ...
  <title>CashFlow &mdash; Password Changed</title>
  <style type="text/css">
...
<body style="margin:0;padding:0;background-color:#f5f5f5;">
  ...
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">
    Your CashFlow password was successfully changed. If this wasn&rsquo;t you, act immediately.
    &#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;
  </div>
                ...
                <tr>
                  <td class="mobile-pad" style="padding:40px 28px 38px;">
                    ...
                    <p style="margin:0 0 28px;${F};font-size:15px;color:#5c5c5c;line-height:1.65;">
                      Your CashFlow account password was successfully updated. You can now sign in with your new password.
                    </p>
                      ...
                      <tr>
                        <td style="padding:16px 20px;">
                          ...
                          <p style="margin:0;${F};font-size:13px;color:#b91c1c;line-height:1.65;">
                            If you did not change your password, your account may be compromised. Reset your password immediately to regain access.
                          </p>
                        </td>
                      </tr>
                    </table>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
                      <tr>
                        <td style="background-color:#ef4444;border-radius:7px;padding:14px 32px;">
                          <a href="${resetPasswordUrl}" style="${F};font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;">
                            Reset my password
                          </a>
                        </td>
                      </tr>
                ...
                <tr>
                  <td class="mobile-pad" style="padding:0 24px 18px;">
                    ...
                    <p style="margin:12px 0 0;${F};font-size:12px;color:#aaaaaa;line-height:1.7;">
                      This activity was recorded on your account. If you do not recognize this action, reset your password and contact support.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td align="center" style="padding:28px 20px 0;">
              <p style="margin:0 0 12px;${F};font-size:12px;color:#aaaaaa;line-height:1.65;text-align:center;">
                You received this because a password change was made to your
