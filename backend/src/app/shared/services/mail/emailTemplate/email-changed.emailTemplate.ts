export const EMAIL_CHANGED_EMAIL_TEMPLATE = (
	oldEmail: string,
	newEmail: string,
	timestamp: string,
	ipAddress: string,
...
<head>
  ...
  <title>CashFlow &mdash; Email Address Changed</title>
  <style type="text/css">
...
<body style="margin:0;padding:0;background-color:#f5f5f5;">
  ...
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">
    Your CashFlow email address has been changed. If this wasn&rsquo;t you, revert it immediately.
    &#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;
  </div>
                ...
                <tr>
                  <td class="mobile-pad" style="padding:40px 28px 38px;">
                    ...
                    <p style="margin:0 0 28px;${F};font-size:15px;color:#5c5c5c;line-height:1.65;">
                      The email address associated with your CashFlow account has been updated.
                    </p>
                          ...
                          <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                              <td style="padding-bottom:10px;">
                                <p style="margin:0 0 3px;${F};font-size:11px;font-weight:600;color:#aaaaaa;text-transform:uppercase;letter-spacing:0.8px;">Previous email</p>
                                <p style="margin:0;${FM};font-size:14px;color:#909090;text-decoration:line-through;">${oldEmail}</p>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td style="padding-top:10px;">
                                <p style="margin:0 0 3px;${F};font-size:11px;font-weight:600;color:#aaaaaa;text-transform:uppercase;letter-spacing:0.8px;">New email</p>
                                <p style="margin:0;${FM};font-size:14px;color:#10b981;font-weight:600;">${newEmail}</p>
                              </td>
                            </tr>
                          </table>
                        </td>
                    ...
                    <!-- Warning box -->
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;background-color:#fef2f2;border-radius:8px;border:1px solid #fecaca;">
                      <tr>
                        <td style="padding:16px 20px;">
                          <p style="margin:0 0 4px;${F};font-size:13px;font-weight:700;color:#991b1b;">Did not make this change?</p>
                          <p style="margin:0;${F};font-size:13px;color:#b91c1c;line-height:1.65;">
                            If you did not update your email address, your account may be compromised.
                            Revert this change immediately to secure your account.
                          </p>
                        </td>
                      </tr>
                    </table>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
                      <tr>
                        <td style="background-color:#ef4444;border-radius:7px;padding:14px 32px;">
                          <a href="${revertUrl}" style="${F};font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;">
                            Revert this change
                          </a>
                        </td>
                      </tr>
                    ...
                    <p style="margin:0;${F};font-size:13px;color:#909090;line-height:1.7;">
                      ...
                      Future notifications will be sent to your new address.
                    </p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:10px;border:1px solid #e4e4e4;">
                <tr>
                  <td class="mobile-pad" style="padding:14px 24px;border-bottom:1px solid #f0f0f0;">
                    <p style="margin:0;${F};font-size:11px;font-weight:700;color:#aaaaaa;text-transform:uppercase;letter-spacing:1.3px;">Request Information</p>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="mobile-pad" style="padding:0 24px 18px;">
                    ...
                    <p style="margin:12px 0 0;${F};font-size:12px;color:#aaaaaa;line-height:1.7;">
                      This notification was sent to your previous email address. If you did not authorise this change, act immediately.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td align="center" style="padding:28px 20px 0;">
              <p style="margin:0 0 12px;${F};font-size:12px;color:#aaaaaa;line-height:1.65;text-align:center;">
                You received this because an email change was made to your
