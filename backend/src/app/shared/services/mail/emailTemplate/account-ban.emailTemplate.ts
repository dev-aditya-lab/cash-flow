export const ACCOUNT_BAN_EMAIL_TEMPLATE = (
	reason: string,
	appealUrl: string,
	unsubscribeUrl = '#',
): string => {
...
<head>
  ...
  <title>CashFlow &mdash; Account Suspended</title>
  <style type="text/css">
...
<body style="margin:0;padding:0;background-color:#f5f5f5;">
  ...
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">
    Your CashFlow account has been suspended. If you believe this is a mistake, you can appeal.
    &#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;
  </div>
                ...
                <tr>
                  <td class="mobile-pad" style="padding:40px 28px 38px;">
                    ...
                    <p style="margin:0 0 28px;${F};font-size:15px;color:#5c5c5c;line-height:1.65;">
                      Access to your CashFlow account has been temporarily suspended due to a violation of our Terms of Service.
                    </p>

                    <!-- Reason box -->
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;background-color:#f9f9f9;border-radius:8px;border:1px solid #ebebeb;border-left:3px solid #ef4444;">
                      <tr>
                        <td style="padding:18px 20px;">
                          <p style="margin:0 0 6px;${F};font-size:11px;font-weight:700;color:#aaaaaa;text-transform:uppercase;letter-spacing:0.8px;">Reason for suspension</p>
                          <p style="margin:0;${F};font-size:14px;color:#1c1c1c;line-height:1.65;">${reason}</p>
                        </td>
                      </tr>
                    </table>
                    ...
                    <p style="margin:0 0 28px;${F};font-size:15px;color:#5c5c5c;line-height:1.65;">
                      ...
                      Our team will review your case and respond within 3&ndash;5 business days.
                    </p>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
                      <tr>
                        <td style="background-color:#1c1c1c;border-radius:7px;padding:14px 32px;">
                          <a href="${appealUrl}" style="${F};font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;">
                            Submit an appeal
                          </a>
                        </td>
                      </tr>
          ...
          <tr>
            <td align="center" style="padding:28px 20px 0;">
              <p style="margin:0 0 12px;${F};font-size:12px;color:#aaaaaa;line-height:1.65;text-align:center;">
                This notification was sent regarding your
