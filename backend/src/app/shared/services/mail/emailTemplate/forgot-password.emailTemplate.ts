...
<head>
  ...
  <title>CashFlow &mdash; Reset Your Password</title>
  <style type="text/css">
...
<body style="margin:0;padding:0;background-color:#f5f5f5;">
  ...
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">
    Reset your CashFlow password. This link expires in 30 minutes.
    &#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;&#847;&#8199;&#65279;
  </div>
                ...
                <tr>
                  <td class="mobile-pad" style="padding:40px 28px 38px;">
                    ...
                    <p style="margin:0 0 28px;${F};font-size:15px;color:#5c5c5c;line-height:1.65;">
                      We received a request to reset the password for your CashFlow account.
                      Click the button below to choose a new password.
                    </p>

                    <!-- Expiry note -->
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;background-color:#fffbeb;border-radius:8px;border:1px solid #fde68a;">
                      <tr>
                        <td style="padding:14px 20px;">
                          <p style="margin:0;${F};font-size:13px;color:#92400e;line-height:1.65;">
                            This reset link expires in <strong>30 minutes</strong>. After that you will need to request a new one.
                          </p>
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td class="mobile-pad" style="padding:0 24px 18px;">
                    ...
                    <p style="margin:12px 0 0;${F};font-size:12px;color:#aaaaaa;line-height:1.7;">
                      If you did not make this request, your account may be at risk. Contact support immediately.
                    </p>
                  </td>
                </tr>
              </table>
